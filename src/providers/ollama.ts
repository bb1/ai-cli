...
- Do not include CSV headers`;
        ...
        return this.callOllamaAPI(prompt, systemPrompt || defaultSystemPrompt);
    }
...
${previousOutput}`;
        ...
        return this.callOllamaAPI(prompt, systemPrompt);
    }
...
- Do not include CSV headers`;
        ...
        return this.callOllamaAPI(originalPrompt, systemPrompt);
    }
}
